function katakana(seq, seg)
   if (seq:sub(-1) == ";" and seq:sub(-2) ~= ";;") then
      ...
      seq = seq:gsub("zzya", "jja"):gsub("zzyu", "jju"):gsub("zzye", "jje"):gsub("zzyo", "jjo")
      seq = seq:gsub( "tya", "cha"):gsub( "tyu", "chu"):gsub( "tye", "che"):gsub( "tyo", "cho")
      seq = seq:gsub( "zya",  "ja"):gsub( "zyu",  "ju"):gsub( "zye",  "je"):gsub( "zyo",  "jo")
      seq = seq:gsub( "jya",  "ja"):gsub( "jyu",  "ju"):gsub( "jye",  "je"):gsub( "jyo",  "jo")
      seq = seq:gsub( "sya", "sha"):gsub( "syu", "shu"):gsub( "sye", "she"):gsub( "syo", "sho")
      seq = seq:gsub("tu", "tsu")
      seq = seq:gsub("ti", "chi")
      seq = seq:gsub("zi", "ji")
      seq = seq:gsub("si", "shi")
